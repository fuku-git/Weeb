...
<body id="page-top">
    ...
    <!-- <header class="masthead" style="background:
            url(&quot;https://publicdomainq.net/images/201706/22s/publicdomainq-0010381tzy.jpg&quot;), url(&quot;https://publicdomainq.net/images/201706/22s/publicdomainq-0010381tzy.jpg&quot;);"> -->
            ...
            <div class="jumbotron" style="background: #f4ed7c;">
                <div class="container">
                    <div class="mt-5">
                        ...
                        <div class="row m-2">
                            <div class="col">
                                <h3 class="text-left" style="color: rgb(29,31,30);font-family: 'Droid Serif';">Mayumi Sudo</h3>
                            </div>
                        </div>
                        <div class="row m-2">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="d-inline-block ml-5">
                                <button type="button" class="btn btn-primary  btn-xl text-uppercase js-scroll-trigger" value="Input">編集
                ...
                <div class="col-md">
                    <form>
                        ...
                        <div class="text-center mr-5">
                            <button type="button" class="btn btn-primary  btn-xl text-uppercase js-scroll-trigger" value="Submit">更新</button>
                        </div>
                    </form>
                </div>
            </div>
