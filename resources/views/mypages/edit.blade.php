                ...
                <div class="container">
                    <div class="mt-5">
                        <div class="float-left mx-4">
                            ...
                            <form method="POST" action="{{ route('mypages.update', $user->id) }}" enctype="multipart/form-data">
                                    @method('PATCH')
                                    @csrf

                                    <img src="{{ $user->icon }}" style="width: 120px;height: 120px;"></span>
                                    <div class="px-2">
                                        <label for="file_photo" class="label label-default">
