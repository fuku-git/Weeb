            ...
            <div class="jumbotron" style="background: #f4ed7c;">
                <div class="container">
                    <div class="mt-5">
                        ...
                        <div class="row">
                            <div class="d-inline-block ml-5">
                                <a href="{{ route('mypages.edit',['id' => $user->user_id])}}">
                                    <button type="button" class="btn btn-primary  btn-xl text-uppercase js-scroll-trigger"  style="color: rgb(18,18,18);background: #fca311; border:none">編集
