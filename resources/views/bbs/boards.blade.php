                                ...
                                <div class="col offset-lg-1" style="display:flex;">
                                    <P><img style="text-align: left; width: 100px;" src="assets/images/インフラ.jpg">
                                        ...
                                        <? foreach($posts as $post): ?>
                                            <dr>
                                                <dd>投稿日：<? $post->create_at->format('Y.m.d') ?></dd>
                                                <dd>ユーザー：<? $post->name ?></dd>
                                                <dd>タイトル：<? $post->post_contents ?></dd>
                                                <dd>内容：<? n12br(e(Str::limit($post->post_body, 100))) ?></dd>
                                                <? if($post->comments->count() >= 1): //コメント未作成?>
